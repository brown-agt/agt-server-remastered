...
osascript -e 'tell application "System Events" to tell process "Terminal" to keystroke "t" using command down' \
          ...
          -e "tell application \"Terminal\" to tell window 1 to do script \"cd '$agent_dir'; clear; python rock_lover/my_agent.py RockLover --run_server\" in selected tab"
...
osascript -e 'tell application "System Events" to tell process "Terminal" to keystroke "t" using command down' \
          ...
          -e "tell application \"Terminal\" to tell window 1 to do script \"cd '$agent_dir'; clear; python ta_agent/my_agent.py TA --run_server\" in selected tab"