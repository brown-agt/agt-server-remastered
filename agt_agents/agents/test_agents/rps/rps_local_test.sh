...
osascript -e 'tell application "System Events" to tell process "Terminal" to keystroke "t" using command down' \
          ...
          -e "tell application \"Terminal\" to tell window 1 to do script \"cd '$script_dir'; clear; python rock_lover.py RockLover\" in selected tab"
...
osascript -e 'tell application "System Events" to tell process "Terminal" to keystroke "t" using command down' \
          ...
          -e "tell application \"Terminal\" to tell window 1 to do script \"cd '$script_dir'; clear; python ta_agent.py TA \" in selected tab"